...
document.querySelector('.ChanelModal .close-btn').addEventListener('click', function () {
    document.querySelector('.ChanelModal').close();
});

document.querySelector('.ChanelModal').addEventListener('click', function (event) {
    if (event.target === this) {
        this.close();
    }
});
